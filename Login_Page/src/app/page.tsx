    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          {/* Header with consistent blue theme */}
          <motion.div
            className="bg-blue-400 p-8 text-center"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <div className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition duration-200"
              ...
              >
                <button
                  type="submit"
                  className="group relative w-full flex justify-center py-2.5 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-400 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 transition duration-200"
                >
